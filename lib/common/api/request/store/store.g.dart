...
Store _$StoreFromJson(Map<String, dynamic> json) => Store(
      ...
      inspection_status:
          Store._inspectionStatusFromJson(json['inspection_status']),
...
Map<String, dynamic> _$StoreToJson(Store instance) => <String, dynamic>{
      ...
      'inspection_status':
          Store._inspectionStatusToJson(instance.inspection_status),
...
StoreListResponse _$StoreListResponseFromJson(Map<String, dynamic> json) =>
    StoreListResponse(
      owner_id: (json['owner_id'] as num?)?.toInt() ?? 0,
      store_count: (json['store_count'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$StoreListResponseToJson(StoreListResponse instance) =>
    <String, dynamic>{
      'owner_id': instance.owner_id,
      'store_count': instance.store_count,
